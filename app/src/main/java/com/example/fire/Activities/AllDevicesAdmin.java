...
public class AllDevicesAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab = findViewById(R.id.fabNewDeviceAdmin);

        getSupportActionBar().setTitle("All Devices - ID");
        ...
        URL = "https://fire-240718.appspot.com/admin/devices/";
                ...
                if(!response.isEmpty())
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            deviceList.add(array.getJSONObject(i).getString("pk"));
                        }
        ...
        lv.setOnItemClickListener(
                new AdapterView.OnItemClickListener(){
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        //Ao clicar num aparecer um pop up com a opção de ele remover o device
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AllDevicesAdmin.this, NewDeviceAdmin.class);
